...
try(system2('gemini',args=" query --header -q 'select chrom, start, end, gene, impact, impact_severity,
              ...
              (cadd_scaled >= 15 OR impact_severity == \"HIGH\")
               ' VARGEMINI_DATABASEPATH --gt-filter \"gt_depths.VARPATIENT_ID > 0\" > raw_var_table_VARPATIENT_ID.tsv", stderr="R_geministderr.txt", env = SNGGEMINIBIN))
```
