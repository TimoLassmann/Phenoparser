...
try(system2(geminibin,args=" query --header -q 'select t1.chrom, t1.start, t1.end, t1.gene, t1.impact, t1.impact_severity,
              ...
              (t1.cadd_scaled >= 15 OR t1.impact_severity == \"HIGH\")
               ' VARGEMINI_DATABASEPATH --gt-filter \"gt_depths.VARPATIENT_ID > 0\" > raw_var_table_VARPATIENT_ID.tsv", stderr="R_geministderr.txt"))
...
try(system2(phenobin,args=" panel  --id VARPATIENT_ID --db VAROMIM_DATABASEPATH --out VARPATIENT_ID", stderr="R_phenoparsererr.txt"));
...
```{r, echo=FALSE,include=TRUE}
     ...
     df <- add_column(df , Info = "<font size=\"+2\" color=\"green\">&oplus;</font>",.before = 1)
       ...
       pageLength=25,
           autoWidth = FALSE,
           columnDefs = list(
                      list(visible=FALSE, targets= c(1:17)),
