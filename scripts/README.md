...
The VT normalize step requires a FASTA reference genome. As indicated in the VT documentation FAQ, just use the appropriate FASTA file that was used to generate your VCF file originally.<br/>
Include the path to this file in the sng_config file using the SNGVTREF variable.

In sng_config:<br/>
    `SNGVTREF=/path/to/fasta/reference/file`<br/>
...
Python is used to integrate ACMG guidelines into the reports. In order for this to run correctly the following libraries need to be installed:
...
Also need to provide the path to your preferred python binary using the SNGPY variable in the sng_config file:<br/>
