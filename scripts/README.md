...
This script combines vcf files from different variant callers and loads them into gemini.
vt decompose and normalization is then run on these files for good measure.
